...
// 3. Mettre la dialogRaise dans le GameUiModel
// 4. Recave
// 5. Ajout de joueur pendant la partie
// 6. Adapter l'UI sur un portable
// 7. Clean le code au maximim en passant dans chaque classes : Ne laissez que des TODOS concernants la DI
// 8. Implementer la DI avec Dagger
